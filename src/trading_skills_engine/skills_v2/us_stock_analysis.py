...
class USStockAnalysisAnalyzer(SkillAnalyzer):
    ...
    def run(self, params: dict[str, Any], context: AnalyzerContext) -> SkillRunResultV2:
        ...
        if context.fmp_news is None:
            ...
            return unavailable_result(
                ...
                summary_ko="FMP API 키가 없어 종목 분석을 수행할 수 없습니다.",
        ...
        try:
            ...
            if not quote and not profile and not metrics and not peers:
                ...
                return unavailable_result(
                    skill_slug=self.slug,
                    summary_ko="종목 소스 데이터가 비어 있어 분석할 수 없습니다.",
            ...
            return unavailable_result(
                skill_slug=self.slug,
                summary_ko="종목 상세 데이터 조회에 실패했습니다.",
    ...
    def _build_payload(
        ...
        change_pct = _to_float(quote.get("changesPercentage"), 0.0)
        pe = _to_float(metrics.get("peRatioTTM") or metrics.get("peRatio"), 0.0)
        roe = _to_float(metrics.get("roeTTM") or metrics.get("roe"), 0.0)
        ...
        return {
            ...
            "fundamentals": {
                ...
                "market_cap": _to_float(profile.get("mktCap"), 0.0),
